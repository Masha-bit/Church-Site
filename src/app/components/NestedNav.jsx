    ...
    <tbody className='h-[50px] sm:h-[auto] w-[100vw] bg-[#f6eee3a6] flex flex-wrap items-center justify-center'>
        <tr className='h-[auto] w-[auto] sm:w-[100%] sm:flex-col items-center justify-center'>
            {ministry_group.map((e) => (
                ...
                <div className={isActive == e ? `hover:cursor-pointer h-[auto] w-[300px] sm:w-[90%] sm:right-0 pb-2 bg-[#d7c9b5] sm:bg-[#ffd79e] text-[#2e1a1a] flex flex-col z-[10] sm:absolute sm:z-[100] text-left`: `hidden`}  onMouseEnter={() => handle_hover(e)} onMouseLeave={() => handle_hover("")}>
