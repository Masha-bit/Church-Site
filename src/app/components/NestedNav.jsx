    ...
    <tbody className='h-[50px] w-[100vw] bg-[#f6eee3a6] flex flex-wrap items-center justify-center'>
        <tr className='h-[auto] w-[auto]  flex items-center justify-center'>
            {ministry_group.map((e) => (
                ...
                <div className={isActive == e ? `hover:cursor-pointer h-[auto] w-[300px] pb-2 bg-[#ad9160] text-[#2e1a1a] flex flex-col z-[10] text-left`: `hidden`}  onMouseEnter={() => handle_hover(e)} onMouseLeave={() => handle_hover("")}>
