...
export default function Nav(props) {
  ...
  return (
    <nav
      ref={ref}
      className={`fixed top-0 left-0 h-[70px] w-[100vw] bg-[#ffffff] flex items-center justify-around font-cinzel text-[${font_rgb}] z-[100] transition-all duration-[350ms] shadow-md`}
    >
      <aside
        className={`h-[100%] w-[40%] flex items-center justify-center font-cinzel text-[19px] text-[${font_rgb}] `}
      >
