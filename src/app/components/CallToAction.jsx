...
const CallToAction = (props) => {  
  ...
  return (
    ...
    <Link href={props.Link} className='my-[1rem]'>
        <div className={`h-[60px] w-[190px] border-[2px] border-[${fill_color}] flex items-center justify-center overflow-hidden bg-transparent relative form-action font-cinzel`}>
             {props.Text} 
