...
<main className='h-[auto] relative'>
    ...
    <section className='h-[auto] w-[100vw] bg-[white] flex flex-col items-center justify- sm:justify-around font-cinzel relative'>
      <p className='w-[100vw] h-[auto] block text-center font-oswald text-[15px] text-[#825835] absolute top-0 left-0'> SACRAMENTS</p>
        ...
        <div className='h-[400px] sm:h-[auto] w-[80vw] sm:w-[100vw] text-[30px] sm:text-[20px] text-[#000000] text-center flex items-center justify-center p-2 sm:p-6 relative'>
        ...
        <div className='h-[auto] w-[100vw] flex flex-col items-center my-[2rem]'>       
          ...
          {sacramentDescription.sacrament.map((s) => 
            (  <aside className='h-[250px] sm:h-[auto]  w-[900px] sm:w-[100%] flex sm:flex-col items-center justify-around '>
